...
# Veritabanı — DATABASE_URL ortam değişkeninden al (Render PostgreSQL)
database_url = os.getenv('DATABASE_URL', '')
# Render bazen postgres:// prefix kullanır, SQLAlchemy postgresql:// ister
...
# Cloudinary yapılandırması (görsel yükleme)
cloudinary.config(
    ...
    if request.method == 'POST':
        try:
            ...
            if question_image and question_image.filename:
                try:
                    upload_result = cloudinary.uploader.upload(question_image)
